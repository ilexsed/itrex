...
public class TextSimplifierTest {
    ...
    public void removeArticles1() throws Exception {
        String str = "This is a result. It is a good one, I think. An anxiety decreased.";
        String result = TextSimplifier.removeArticles(str);
        String expected = "This is result. It is good one, I think. anxiety decreased.";
        assertEquals(expected, result);
    }
